...
#C file write time: 2025-09-12  14:03:06
S98_data.dat
S98_control.ctl
...
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2033
...
# 2 8 #_min and max age over which average F will be calculated, with F=Z-M
...
1e-05 # ALK tolerance ***disabled in code (example 0.0001)
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1758111280
